...
All algorithms in this folder follow the same high-level structure:
...
- `*_algorithm.py`: QGIS Processing wrappers (parameters, execution, output fields, help text).
- `*_worker.py`: geometry solvers independent from QGIS/Qt runtime.
- `numba_bootstrap.py`: optional Numba bootstrap helper.
