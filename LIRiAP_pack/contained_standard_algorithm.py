...
from contained_standard_worker import _worker_process_feature, _NUMBA_AVAILABLE
...
class InscribedRectangleContainedStandard(QgsProcessingAlgorithm):
    INPUT = "INPUT"
    OUTPUT = "OUTPUT"
    ...
    def name(self):
        return "lir_contained_standard"

    def displayName(self):
        return self.tr("Contained Standard")
    ...
    def createInstance(self):
        return InscribedRectangleContainedStandard()

    def tr(self, s):
        return QCoreApplication.translate("Processing", s)

    def shortHelpString(self):
        return build_short_help("Contained Standard", "contained_standard", _NUMBA_AVAILABLE)
