...
from bcrs_worker import _worker_process_feature, _NUMBA_AVAILABLE
...
class InscribedRectangleBCRS(QgsProcessingAlgorithm):
    INPUT = "INPUT"
    OUTPUT = "OUTPUT"
    ...
    def createInstance(self):
        return InscribedRectangleBCRS()

    def tr(self, s):
        return QCoreApplication.translate("Processing", s)

    def shortHelpString(self):
        return build_short_help("BCRS", "bcrs", _NUMBA_AVAILABLE)
